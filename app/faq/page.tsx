...
ただし、参加者同士のやり取りや進捗共有はグループDMで行うため、Xアカウントをお持ちの方を対象としています。
初参加の方は安全面の理由からXのpostを拝見させていただき検討させていただきます。

また、各パートの人数バランスや難易度を考慮してメンバーを決定しています。  
希望パートが集中した場合は第二希望で調整させていただくこともあります。  
出来るだけ多くの方に楽しんでいただけるよう調整させていただけたらと思います🎸`,
        },
        {
...
譜面が読めない方や複雑なパート割の場合は動画を用意することも可能です。📹`,
        },
        {
          q: "演奏レベルはどのくらいですか？",
...
バック音源は指定のものを聴いていただきながら演奏・歌唱します。こちらは任意参加です。
いただいた動画を運営にて編集してコラボ動画としてYouTubeへアップするという企画になります。
可能であれば雑音が入らないようLINE接続だと助かります🙇‍♀️`,
        },        
        {
          q: "友人と一緒に参加できますか？",
          a: `もちろん可能です！  
応募フォームで『同伴希望』を記載していただければ、出来る限り調整します。`,
        },
        {
          q: "地方からでも参加できますか？",
          a: `全国からのご参加OKです！  
