...
主催が全体バランスを見ながら担当を割り振って譜面を案内します。  
必要に応じて簡略化アレンジも行うので、初心者の方も安心して参加できます📖`,
        },
        {
          q: "演奏レベルはどのくらいですか？",
          a: `演奏者の経験に応じてパート割します。  
初めての方には簡単なパートを優先的にご案内しますのでご安心ください！`,
        },
        {
          ...
          a: `はい！  
リハーサル時に各パートの音量や音色、バランスを確認します。  
エフェクター設定や音作りに不安がある方は、  
事前にご相談いただければサポートします🎛️`,
        },
        {
          q: "演奏は撮影されますか？",
          a: `はい！  
当日は2〜3台のカメラで撮影し、後日編集した映像をYouTubeに公開します。  
撮影データは全員に共有され、思い出としても残ります📸`,
        },
        {
          q: "もし演奏をミスしたらどうなりますか？",
          a: `ミスしても大丈夫です！  
...
- チケット兼領収書発行`,
        ...
        {
          q: "支払い方法は？",
          a: `現金・PayPay・クレジットカード（Visa/Master/JCB等）に対応しています。  
当日までにお支払いでOKです。`,
        },
        {
          q: "キャンセル料はありますか？",
        ...
        {
          q: "プラン変更は可能ですか？",
          a: `After Party参加の可否については、後からでも変更可能です！`,
        },
        {
          q: "領収書はもらえますか？",
          a: `はい。  
...
開催地によって異なりますが、基本的には土日祝に実施しています。`,
        ...
        {
          q: "集合時間はどのくらい？",
          a: `お昼前後に集合し、夕方〜夜にかけて本番演奏を行うスケジュールが多いです。  
詳細は参加者決定後にメールでお知らせします。`,
        },
        {
          q: "会場はどこですか？",
...
最新情報は公式サイトやXでお知らせします📢`,
        },
        {
          q: "写真や動画は公開されますか？",
          a: `はい。  
YouTubeやSNSで公開予定ですが、ご希望があればモザイク対応します。`,
        },
        {
          q: "友人と一緒に参加できますか？",
          a: `もちろん可能です！  
