  ...
  const faqCategories = [
    {
      ...
      items: [
        ...
        { q: "誰でも参加できますか？", a: "不特定多数の応募があるため参加には選考があります。安全性を確認とグループDMでの運用のためXアカウントのある方を対象としています。" },
        { q: "楽器が演奏できなくても参加できますか？", a: "基本的には楽器演奏がメインとなりますが、ボーカルやコーラスなどの場合は楽器が弾けなくても問題ありません。" },
        ...
        { q: "飲み会参加は必須ですか？", a: "参加不参加はオプションで選択できます！" },
    ...
    },
    {
      category: "費用について",
      items: [
        { q: "参加費はいくらですか？", a: "5000円になります。＋オプション4000円追加で打ち上げに参加できます。" },
        { q: "支払い方法は何がありますか？", a: "現金、PayPay、クレジットカード各種に対応しています。" },
        { q: "当日までに費用を支払う必要がありますか？", a: "当日支払いでも全く問題ありません。現金以外の場合は事前支払いも可能です。" },
    ...
    },
    {
      ...
      items: [
        ...
        { q: "1曲丸ごとは弾けませんが大丈夫ですか？", a: "経験歴や希望を確認して弾ける範囲で問題ありません。" },
        { q: "間違えたらどうしようと不安です。", a: "ミスしても問題ないです！5ヶ月間あるので練習いただければ大丈夫です。" },
        { q: "動画とCDの音源どれが譜面と全く同じですか？", a: "完全に同じ譜面はありません。譜面でパートをお伝えします。" },
        { q: "ボーカル初めてですが良いですか？", a: "初めてでも全然大丈夫です！生バンドで歌う楽しさを満喫してください！" },
        { q: "譜面やカンペ見てもいいですか？", a: "はい！見ていただいて全然大丈夫です。譜面台がありますのでご利用ください。" },
        { q: "座ってしか演奏できません。", a: "椅子を準備しますので安心してください^^/" },
      ],
    },
    {
      category: "当日について",
      items: [
        { q: "日にちはいつになりますか？", a: "参加メンバーにアンケートをお願いし、調整してご連絡します。" },
        { q: "集合時間は何時ですか？", a: "参加者の都合に合わせて調整しますが、昼前〜夜までが多いです。" },
        { q: "会場はどこですか？", a: "毎回異なるので決定次第ご連絡します。" },
        { q: "どのくらいの時間演奏しますか？", a: "スタジオの時間は5Hですが、途中休憩もあります。" },
        { q: "見学や応援だけの参加は可能ですか？", a: "基本的に見学だったらタンバリンを…と何か持たせたがる主催者ですw サポート役でも大歓迎です。" },
        { q: "当日必要な持ち物はありますか？", a: "普段演奏する際に必要な機材をお持ちください。" },
        { q: "服装に決まりはありますか？", a: "自由ですが、動画を撮るので映っても問題ない服装でお願いします。" },
        { q: "リハーサルはどのくらい行いますか？", a: "2時間くらい練習時間があります。" },
    ...
    },
    {
      ...
      items: [
        ...
        { q: "音楽ジャンルは限定されていますか？", a: "主催者の好みで基本的にGLAYです。SOUL LOVE＋もう一曲といった感じです。" },
        { q: "写真や動画がSNSに公開される場合がありますか？", a: "はい！この企画の醍醐味でもあります。モザイク処理はご希望に合わせて対応します。" },
        { q: "次回開催予定はありますか？", a: "春と秋の年に2回開催予定です。開催地は全国各地でエントリー前にご案内します。" },
      ],
    },
  ];
