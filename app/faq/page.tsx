...
export default function FAQPage() {
  const faqCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { q: "領収証など発行してもらえますか？", a: "はい、4thから参加費制に移行後はチケット兼領収書を発行いたします。" },
      ],
    },
    {
      category: "演奏について",
      items: [
        ...
        { q: "誰かと演奏したことがありません。", a: "絶好の機会ですね！ぜひ合わせる楽しさを体感してください！" },
        { q: "パート割はどうなりますか？", a: "スキルやご希望により調整させていただきます。" },
        { q: "音作りがわかりません。", a: "音源に寄せると方向性は見えやすいです。不安であれば動画などを送っていただければアドバイスします。" },
    ...
    },
    {
      ...
      items: [
        ...
        { q: "当日体調不良で参加できなくなった場合はどうすればいいですか？", 
          a: <>公式メールアドレスにご連絡ください：<a href="mailto:info@1daystudioband.com" style={{ color: "var(--color-accent)", textDecoration: "underline" }}>info@1daystudioband.com</a></> 
        },],
    },
    {
      category: "その他",
  ...
  return (
    <section style={{ padding: "4rem", backgroundColor: "#000", color: "white" }}>
                ...
                {cat.items.map((faq, j) => {
                  ...
                  return (
                    <div key={key} style={{ marginBottom: "1rem", border: "1px solid #444", borderRadius: "6px", overflow: "hidden" }}>
                      ...
                      {isOpen && (
                        <div style={{ padding: "0.8rem 1rem", backgroundColor: "#222" }}>
