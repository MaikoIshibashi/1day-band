    ...
    <main className="min-h-screen bg-black text-gray-100 px-6 py-12 pt-28">
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-200">
            ...
            <li>他イベントや個人活動などの宣伝・勧誘はご自身のSNSでお願いします。</li>
            <li>批判・マウントなど、他の方が不快に感じる行為はお控えください。</li>
            <li>
            グループDMは管理のため、YouTube公開完了後に運営は退出させていただきますが、
            <p className="mt-1">
                イベント終了後は、必要に応じてご自身の判断で退会していただいて構いません。
            </p>
            <p className="mt-1">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-200">
            ...
            <li>
              ...
              参加をお断りさせていただく場合があります。みんなが安心して楽しめる空間を守るための
              対応となりますので、ご理解ください🙏
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-200">
            ...
            <li>忘れ物や体調不良など、何かあればすぐに運営までお声かけください。</li>
          </ul>
        </section>
